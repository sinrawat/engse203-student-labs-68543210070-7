...
| **ผู้จัดทำ** | `ศิลวัต อาซอง 68543210070-7` |
...
**ทำอะไร** `เปลี่ยนสถานะของคำร้องที่ระบุด้วย ID`
...
| 2.0.0 | `24/09/2026` | เพิ่ม `PUT /api/requests/:id` และ CORS | ไม่ |
